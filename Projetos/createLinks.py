import json
import os
from defaultLinksFunctions import create_links_txt
...
class CreateLinksJson:
    ...
    def generateLinksFollowing(self):
        self.input_file_name = self.username_for_scrape + "following.json"
        self.input_file_path = os.path.join(self.current_directory, self.input_file_name)
        self.temp_file_name = self.username_for_scrape + "following_temp.json"
        self.temp_file_path = os.path.join(self.current_directory, self.temp_file_name)
